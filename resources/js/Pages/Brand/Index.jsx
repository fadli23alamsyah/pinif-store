...
export default function Index(props) {
    ...
    const destroy = () => {
        Inertia.visit(route('brand.destroy'),{
            method: 'delete',
            data: brand,
            onFinish: () => setBrand({}),
        })
    ...
    return (
        <AuthenticatedLayout
            auth={props.auth}
            errors={props.errors}
            header={<h2 className="font-semibold text-xl text-white leading-tight">Daftar Merek</h2>}
        >
            <Head title="Daftar Merek" />
            ...
            <div className="py-6 px-6">
                ...
                <div className="p-4 sm:p-8 bg-white shadow rounded-lg">
                    <PrimaryButton
                        ...
                        onClick={ () => window.location.href = route('brand.add')}
                            ...
                            {props.data.map((item, i) => 
                                <tr key={i}>
                                    ...
                                    <td className='flex flex-wrap gap-2'>
                                        <IconEditButton onClick={() => window.location.href = route('brand.edit',item)} />
            ...
            <Modal show={showDelete} maxWidth="md" onClose={closeModalDelete}>
                <div className="p-4">
                    ...
                    <div className="mt-4">Apakah anda yakin ingin menghapus data {brand.name !== undefined ? brand.name : ''}</div>
